...
const  UpdatePackage = (props: any) => {
    const {handleToggle, countryOfSupply, destination, getPackages, countries, purchaseOrderNumber, selectedPurchaseOrderPackages} = props
    ...
    const getPurchaseOrder = () => {
        ...
        var request: Record<string, any> = {
            ...
            id: searchValue ? searchValue : purchaseOrderNumber,
            params: {
                UserId: user?.id,
    ...
    const isDataComplete = (data: any) => {
        ...
        const allFieldsProvided = Object.keys(data)
                .filter(key => (key !== "error" && key !== "packageId")) // Exclude the "error" key
                .every(key => data[key]);
                        ...
                        purchaseOrderItems: 
                            distinctPurchaseOrderItemIds.map((id: any) => {
                                ...
                                return ({
                                    ...
                                    quantity: isChecked ? itemSuppy.quantity : "",
