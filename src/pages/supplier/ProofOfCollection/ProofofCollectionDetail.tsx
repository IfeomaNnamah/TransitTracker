...
const ProofOfCollectionDetail =  () => {
    ...
    const roles = useSelector((state: any) => state.roles.value);
    ...
    const submitResponse = () => {
        ...
        var request = {
            what: "SubmitSupplierPOCApproval",
            data: {
        ...
        makePatchRequest(request)
            .then((response: any) => {
                ...
                setTimeout(() => {
                    navigate("/supplier/proofofcollection")
                }, 1000);  
            })
            .catch((error) => 
                ...
                <div className="main">
                    <div className="main-inner mt-2">                  
                        <div className="detail-top-section">
                            <Link to="/supplier/proofofcollection" className="actions">
                    ...
                    {(proofOfCollection?.supplierApproval === "PENDING" && 
