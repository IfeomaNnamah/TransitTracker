                ...
                <div className="main">
                    <div className="main-inner mt-2">                  
                        <div className="detail-top-section">
                            <Link to={"/executivedirectortechnicaldirectorate/modeoftransportationchange"} state={{status: statusAfterNavigation?.status}} className="actions">
                    ...
                    <div className="main-inner mt-1" style={{minHeight: "500px"}}><PdfGenerator role="Executive Director Technical Directorate" /></div>
                </div>
            </div>
        </Layout>
    )
