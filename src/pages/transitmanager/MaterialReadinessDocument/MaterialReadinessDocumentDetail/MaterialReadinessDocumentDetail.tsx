    ...
    const handleSendChat = (e: FormEvent) => {
        ...
        var request: Record<string, any> = {
            ...
            data: {
                ...
                receiver: "ExpeditingTeam", // enter supplier id for the mrd
            }
        };
        ...
        makePatchRequest(request)
            .then((response: any) => {
                ...
                setTimeout(() => {
                    navigate("/transitmanager/materialreadinessdocument")
                }, 1000);
        ...
        <Layout title={page}>
            <div className="container">
                    ...
                    <div className="main-inner mt-2">                  
                        <div className="detail-top-section">
                            <div className="d-flex">
                                <div onClick={() => navigate(pageContext?.url ? pageContext.url : "/transitmanager/materialreadinessdocument", {state:{status: statusAfterNavigation?.status}}) } className="actions">
                                    <p><span className="material-symbols-rounded">arrow_back</span> Back to {pageContext?.view}Material Readiness Documents</p>
                                </div>
                                <div className="actions"
                                    onClick={() => {
                                        setOpenChatHistory(true); 
                                        getMaterialReadinessDocumentChatHistory(materialReadinessDocument.id)
                                        setChatData({...chatData, materialReadinessDocumentId: materialReadinessDocument.id,})} }>
                ...
                <Modal isOpen={openChatHistory} style={customStyles} className="modal modal-7" ariaHideApp={false}>
                    ...
                    {materialReadinessDocument?.materialReadinessDocumentStatus === "UNASSIGNED" 
