                ...
                <div className="main">
                    <div className="main-inner mt-2">                  
                        <div className="detail-top-section">
                            <Link to={"/transitmanager/modeoftransportationchange"} state={{status: statusAfterNavigation?.status}} className="actions">
                    ...
                    <div className="main-inner mt-1" style={{minHeight: "500px"}}><PdfGenerator role="Transit Manager" /></div>
                </div>
            </div>
        </Layout>
    )
