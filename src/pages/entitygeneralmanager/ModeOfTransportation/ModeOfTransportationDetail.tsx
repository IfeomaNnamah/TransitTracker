                ...
                <div className="main">
                    <div className="main-inner mt-2">                  
                        <div className="detail-top-section">
                            <Link to={"/entitygeneralmanager/modeoftransportationchange"} state={{state: statusAfterNavigation?.status}} className="actions">
                    ...
                    <div className="main-inner mt-1" style={{minHeight: "500px"}}><PdfGenerator role="Entity General Manager" /></div>
                </div>
            </div>
        </Layout>
    )
