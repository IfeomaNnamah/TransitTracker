...
import { POItemSupplyStatus, POItemStatus, formatCurrency, formatDateTime, getCurrencySymbol, getPurchaseOrderItemStatus, getPOItemSupplyStatusIndex, handleCopy } from "../../helpers";
...
const PurchaseOrder =  () => {
    ...
    useEffect(() => {
        if(accessToken && purchaseOrderNumber) {
            getPurchaseOrder()
            navigate("/deputygeneralmanagertechnicallogistics/purchaseorders/"+purchaseOrderNumber)
