                    ...
                    <div className="main-inner mt-2">                  
                        <div className="detail-top-section">
                            <div className="d-flex">
                                <div onClick={() => navigate(pageContext?.url ? pageContext.url : "/transitofficer/materialreadinessdocument", {state:{status: statusAfterNavigation?.status}}) } className="actions">
