                ...
                <div className="main">
                    <div className="main-inner mt-2">                  
                        <div className="detail-top-section">
                            <Link to={"/generalmanagertechnicallogistics/modeoftransportationchange"} state={{status: statusAfterNavigation?.status}} className="actions">
                                <p><span className="material-symbols-rounded">arrow_back</span> Back</p>
                            </Link>
                    ...
                    <div className="main-inner mt-1" style={{minHeight: "500px"}}><PdfGenerator role="General Manager Technical Logistics" /></div>
                </div>
            </div>
        </Layout>
    )
