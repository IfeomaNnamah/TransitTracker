                ...
                <div className="layout">
                    ...
                    <div className="body d-grid-2"> 
                        ...
                        <div className='form-item span-col-2'>
                            <label>Pickup Address . <span className="blue-text" 
                                onClick={() => setOpenChatModal(true)}
                                title="Request Pickup Address Update From Supplier"
                                >Request Update</span></label>
            ...
            <Modal isOpen={openChatModal} style={customStyles} className="modal modal-5" ariaHideApp={false}>
                ...
                <div className="alert alert-warning" style={{margin: "12px 0 0 0 ", padding: "8px", width: "auto", alignItems: "start"}}>
                    ...
                    <div style={{fontSize: "10.5px"}}>
                        ...
                        <span style={{fontWeight: "300"}}>Sending a request for pickup address update requires the supplier to update the material readiness document before approval. Avoid initiating if no update is needed.</span>
                    </div>
                </div>
